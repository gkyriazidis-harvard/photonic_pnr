// This code contains the class definition of a bend
// The ID of a bend is (0)
// -----------------------------------------------------------------------------------------------------------------------

class bend : public photo_device {
...
public:
    ...
    // Constructor
    bend(point xy_position, int id, string label) : photo_device(id, label) {
